...
#' \item \code{terr()}: terrestrial topographical colours.
...
#' 
#' @export 
terr <- colorRampPalette(c("#336600","#F3CA89","#D9A627","#A49019",
...
showPal <- function(pal="all"){
  pals <- c("ocean", "gradinv", "terr", "ipccTemp", "ipccPrec", "wet", "ipccLine", "ipccRCP")
  n <- c(rep(11,6), 6, 4)
